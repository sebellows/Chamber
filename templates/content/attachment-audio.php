<?php if ( is_attachment() ) : // If viewing a single attachment. ?>
	...
	<div class="attachment-meta">
		...
		<div class="media-info">
			...
			<h3><?php _e( 'Audio Info', 'chamber' ); ?></h3>
			...
			<ul class="media-meta">
				...
				<?php hybrid_media_meta( 'artist',            [ 'before' => sprintf( $pre, esc_html__( 'Artist',    'chamber' ) ), 'after' => '</li>' ] ); ?>
				<?php hybrid_media_meta( 'album',             [ 'before' => sprintf( $pre, esc_html__( 'Album',     'chamber' ) ), 'after' => '</li>' ] ); ?>
				<?php hybrid_media_meta( 'track_number',      [ 'before' => sprintf( $pre, esc_html__( 'Track',     'chamber' ) ), 'after' => '</li>' ] ); ?>
				<?php hybrid_media_meta( 'year',              [ 'before' => sprintf( $pre, esc_html__( 'Year',      'chamber' ) ), 'after' => '</li>' ] ); ?>
				<?php hybrid_media_meta( 'gennre',            [ 'before' => sprintf( $pre, esc_html__( 'Genre',     'chamber' ) ), 'after' => '</li>' ] ); ?>
