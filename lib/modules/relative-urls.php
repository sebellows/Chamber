...
namespace Chamber\Theme\RelativeURLs;
...
Utils\add_filters($root_rel_filters, 'Chamber\\Theme\\Utils\\root_relative_url');

add_filter('wp_calculate_image_srcset', function ($sources) {
    foreach ($sources as $source => $src) {
        $sources[$source]['url'] = \Chamber\Theme\Utils\root_relative_url($src['url']);
    }
    return $sources;
});
