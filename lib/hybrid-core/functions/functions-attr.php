...
## Post-specific attributes.
add_filter( 'hybrid_attr_post',            'hybrid_attr_post',            5    ); // Alternate for "post".
add_filter( 'hybrid_attr_post-title',      'hybrid_attr_post_title',      5    );
add_filter( 'hybrid_attr_post-author',     'hybrid_attr_post_author',     5    );
add_filter( 'hybrid_attr_post-published',  'hybrid_attr_post_published',  5    );
add_filter( 'hybrid_attr_post-content',    'hybrid_attr_post_content',    5    );
add_filter( 'hybrid_attr_post-terms',      'hybrid_attr_post_terms',      5, 2 );
 ...
 * @return array
 */
function hybrid_attr_post_title( $attr ) {
 ...
 * @return array
 */
function hybrid_attr_post_author( $attr ) {
 ...
 * @return array
 */
function hybrid_attr_post_published( $attr ) {
 ...
 * @return array
 */
function hybrid_attr_post_content( $attr ) {
 ...
 * @return array
 */
function hybrid_attr_post_terms( $attr, $context ) {

  if ( !empty( $context ) ) {

    $attr['class'] = 'post-terms ' . sanitize_html_class( $context );
